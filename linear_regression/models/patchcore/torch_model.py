...
from models.components.feature_extractors import TimmFeatureExtractor
from models.components.sampling import KCenterGreedy
...
class PatchcoreModel(DynamicBufferModule, nn.Module):
    ...
    def forward(self, input_tensor: Tensor) -> Tensor | tuple[Tensor, Tensor]:
        ...
        with torch.no_grad():
            features = self.feature_extractor(input_tensor)  # 2nd and 3rd layer
        ...
        _patch_scores, locations = self.nearest_neighbors(embedding=embedding, n_neighbors=1)
        # reshape to batch dimension
        patch_scores = _patch_scores.reshape((batch_size, -1))
        ...
        # print("Anomaly Score is ", anomaly_score)
        # output = (_patch_scores, embedding)
        return output
